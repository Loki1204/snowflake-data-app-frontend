...
function Home() {
  ...
  const labelFormatter = (number) => {
    if (number > 1000000000) {
      return (
        "$" + (Math.round((number / 1000000000) * 100) / 100).toString() + "B"
      );
    } else if (number > 1000000) {
      return (
        "$" + (Math.round((number / 1000000) * 100) / 100).toString() + "M"
      );
    } else if (number > 1000) {
  ...
  return (
    <div>
      <div className="home-header">
        ...
        <Button className="backBtn" onClick={gotoDetails}>
          {" "}
          🚚 Truck Details
        </Button>
        <Button className="home-logoutBtn" onClick={logout}>
          ⎋ Logout
        </Button>
      </div>
      ...
      <div className="homerow">
        <div className="row1col">
          <div className="colHeader">Top 10 Countries</div>
          <div className="homecol">
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                ></XAxis>
                <YAxis type="category" dataKey="COUNTRY"></YAxis>
                <Tooltip
                  formatter={(value) =>
                    "US$" + new Intl.NumberFormat("en").format(value)
                  }
                />
        ...
        <div className="row1col">
          <div className="colHeader">Top 10 Trucks</div>
          <div className="homecol">
      ...
      <div className="homerow">
        <div className="row2col">
          <div className="colHeader">YTD Revenue By Country</div>
          <div className="homecol">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart
                width={500}
